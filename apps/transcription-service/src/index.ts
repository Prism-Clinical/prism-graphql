...
import { initializeQueue } from "./services/transcription-queue";

const port = "4007";
const subgraphName = "transcription";
...
async function main() {
  ...
  // Initialize BullMQ queue for transcription jobs
  initializeQueue(redis);
