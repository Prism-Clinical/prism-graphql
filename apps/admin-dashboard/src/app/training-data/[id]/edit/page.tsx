...
export default function EditTrainingDataPage({ params }: { params: { id: string } }) {
  const { id } = params;
  ...
  if (!carePlan) {
    return (
      <div className="text-center py-12">
        <p className="text-red-600">Training data not found.</p>
  ...
  return (
    <div>
      <div className="flex items-center gap-4 mb-6">
        ...
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Edit Training Data</h1>
