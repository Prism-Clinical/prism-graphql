...
export default function ViewTrainingExamplePage({ params }: { params: { id: string } }) {
  const { id } = params;
  ...
  if (error || !carePlan) {
    return (
      <div className="text-center py-12">
        <p className="text-red-600">Failed to load training example.</p>
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-gray-500">Training example details</p>
          </div>
        </div>
        <Link href={`/training-examples/${id}/edit`}>
          <Button>
