      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="mt-1 text-sm text-gray-500">
            Manage care plan examples for RAG context and ML model training
            {totalCount > 0 && ` (${totalCount} examples)`}
          </p>
        </div>
        <Link href="/training-examples/new">
          <Button>
        ...
        <CardBody>
          {loading ? (
            ...
            <div className="text-center py-12 text-red-600">
              <p>Error loading training examples. Please try again.</p>
            </div>
          ) : carePlans.length === 0 ? (
            <EmptyState
              title="No training examples found"
                  ...
                  <TableRow key={carePlan.id}>
                    ...
                    <TableCell>
                      <div className="flex gap-2">
                        <Link href={`/training-examples/${carePlan.id}`}>
                          <Button variant="ghost" size="sm">View</Button>
                        </Link>
                        <Link href={`/training-examples/${carePlan.id}/edit`}>
