...
export default function NewTrainingExamplePage() {
  ...
  return (
    <div>
      <div className="flex items-center gap-4 mb-6">
        ...
        <div>
          <h1 className="text-2xl font-bold text-gray-900">New Training Example</h1>
          <p className="mt-1 text-sm text-gray-500">
            Create a care plan example for training and RAG context
          </p>
        </div>
      </div>
        ...
        <div className="space-y-6">
          ...
          <div className="flex justify-end gap-4">
            ...
            <Button type="submit" disabled={loading}>
              {loading ? <Spinner className="h-4 w-4" /> : 'Create Training Example'}
            </Button>
          </div>
        </div>
      </form>
