...
export default function EditCarePlanPage({ params }: { params: { id: string } }) {
  const { id } = params;
  ...
  if (!template) {
    return (
      <div className="text-center py-12">
        <p className="text-red-600">Care plan not found.</p>
  ...
  return (
    <div>
      <div className="flex items-center gap-4 mb-6">
        <Link href={`/care-plans/${id}`}>
          <Button variant="ghost" size="sm">
            <ArrowLeftIcon className="h-4 w-4" />
          </Button>
        </Link>
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Edit Care Plan</h1>
      ...
      <div className="space-y-6">
        ...
        <Card>
          ...
          <CardBody>
            <p className="text-sm text-gray-500 mb-4">
              Goals are defined when creating the care plan. To modify goals, create a new version.
            </p>
        ...
        <Card>
          ...
          <CardBody>
            <p className="text-sm text-gray-500 mb-4">
              Interventions are defined when creating the care plan. To modify interventions, create a new version.
            </p>
